          ...
          column: [
            {
              ...
              column: [
                ...
                },
                {
                  ...
                  column: [
                    { html: 'همکار گرامی' },
                    { html: 'بروکس برای شما امسال 15،000،000 ریال عیدی درنظرگرفته است. ' },
                    { html: 'این عیدی در قالب تخفیف خرید بر روی بسته عیدانه بروکس به شما تعلق می گیرد.' },
                    { html: 'قیمت کالاهای این بسته بر اساس دلار نیمایی (30 هزار تومانی) محاسبه گردیده است.' },
                  ]
                },
                {
                ...
                { size: 12 },
                {
                  ...
                  style: { textAlign: 'right' },
                  column: [
                    { html: '1- همه قیمت ها به تومان می باشد.' },
                    { html: '2- هر مشتری می تواند یک بسته عیدی بروکس را دریافت کند.' },
                    { html: '3- رنگ نور همه محصولات مهتابی می باشد.' },
                    { html: '4- پرداخت این طرح فقط به صورت آنلاین می باشد.' },
                    { html: '5- تعداد بسته های در نظر گرفته محدود می باشد .' },
                    { html: '6- این طرح تا 1401/12/13 معتبر میباشد.' },
                    { html: '7- بسته به موجودی کالا ها امکان توقف قبل از تاریخ فوق ممکن است.' }
                  ]
                },
              ]
            },
