    ...
    constructor(props){
        ...
        this.state = {
            ...
            texts:[
                ...
                تازه! امسال عیدی هم میدیم. در این عید همراه می ارزه و بروکس باشید.`,
                ...
                `
                چقدر خوبه مشتری عیدی شو از مغازه شما بگیره.
همراه همیشگی همین حالا تو طرح ثبت نام کن.
موقع ورود به طرح اگر 5 کارتن از محصولات جشنواره نورواره3 بروکس بخری، یک کارتن لامپ 7 وات حبابی رایگان برای تو ارسال میشه.
...
روزای خوب دخلتون تو راهه.
            ...
            sharayet:()=>{
                ...
                let src;
                try{
                    src = JSON.parse(userInfo.norvareh3QR)
                }
                catch{
                    src = ''
                }
                    ...
                    <RVD
                        layout={{
                            column:[
                                ...
                                {html:<img src={src} alt='' width={300}/>,align:'vh'},
                                ...
                                {html:'4- لامپ رایگان 7 وات حبابی که در جعبه رنگی دارای برچسب قرار دارد را فقط مطابق با دستورالعمل نورواره و پس از دریافت تاییدیه مجری به مشتری تحویل دهم.'},
                                ...
                                {row:[{html:bulet,size:24,align:'vh'},{html:'حداکثر ظرف مدت 72 ساعت کالا را به دست مصرف­کننده برسانم.'},]},
                                {row:[{html:bulet,size:24,align:'vh'},{html:'کلیه کالاهای ارسالی بر اساس فاکتور را تست نمایم و از سالم بودن آن­ها اطمینان حاصل کنم.'},]},
                                {row:[{html:bulet,size:24,align:'vh'},{html:'هیچ­گونه مبلغ اضافی از مصرف­کننده دریافت ننمایم.'},]},
                                {row:[{html:bulet,size:24,align:'vh'},{html:'لامپ رایگان 7 وات حبابی را طبق فاکتور و به تعداد مشخص شده در فاکتور به مصرف­کننده تحویل دهم.'},]},
                                {row:[{html:bulet,size:24,align:'vh'},{html:'کد تحویل را از مصرف­کننده دریافت نموده و در سامانه ثبت نمایم.'},]},
